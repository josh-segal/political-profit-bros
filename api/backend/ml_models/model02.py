...
def initalize(step=70):
    ...
    # Step 5
    df_close, df_training_size, df_training_predictions, df_testing_predictions, start_date = make_predictions(model, df_x_training, df_x_testing, df_scaler)
